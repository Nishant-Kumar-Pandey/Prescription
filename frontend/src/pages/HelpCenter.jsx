  ...
  return (
    <div className="max-w-4xl mx-auto space-y-12 py-8 animate-fade-in transition-colors duration-300">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        <div className="glass-card p-8 space-y-6 border border-white/40 dark:border-white/10 shadow-xl bg-white/10 dark:bg-neutral-900/40 transition-colors">
          <h2 className="text-2xl font-bold text-slate-800 dark:text-neutral-100 flex items-center space-x-3 transition-colors">
          ...
          <div className="space-y-4">
            {[1, 2, 3, 4].map((step) => (
              <div key={step} className="flex space-x-4 items-center">
                ...
                <p className="text-slate-600 dark:text-neutral-400 text-sm font-semibold transition-colors">
      ...
      <div className="space-y-8 py-8">
        <h2 className="text-3xl font-extrabold text-slate-800 dark:text-neutral-100 text-center transition-colors">Frequently Asked Questions</h2>
        <div className="grid gap-6 max-w-3xl mx-auto">
          {faqs.map((faq, i) => (
            <div key={i} className="glass-card p-8 space-y-3 border border-slate-100 dark:border-white/5 shadow-soft hover:border-medical-primary/20 transition-colors bg-white/10 dark:bg-neutral-900/40">
              <h4 className="font-bold text-xl text-slate-800 dark:text-neutral-100 transition-colors">{faq.q}</h4>
              <p className="text-slate-600 dark:text-neutral-400 leading-relaxed font-medium transition-colors">{faq.a}</p>
            </div>
          ))}
        </div>
      </div>
